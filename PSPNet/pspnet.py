...
from model import self_net as  pspnet
...
class PSPNet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        #"model_path"        : './logs/train150_test100/ep190-loss0.085-val_loss0.106.pth',
    ...
    def generate(self, onnx=False):
        ...
        #self.net    = self_net(num_classes=self.num_classes, downsample_factor=self.downsample_factor, pretrained=False, backbone=self.backbone, aux_branch=False)
