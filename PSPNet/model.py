...
class MobileNetV2d(nn.Module):
    def __init__(self, downsample_factor=8, pretrained=True):
        super(MobileNetV2d, self).__init__()
        from functools import partial
...
class self_net(nn.Module):
    def __init__(self, num_classes=4, downsample_factor=8, backbone="mobilenet", pretrained=False, aux_branch=True):
        ...
        if backbone == "resnet50":
            ...
            #   o为主干部分     [30,30,320]
            # ----------------------------------#
            self.backbone = MobileNetV2d(downsample_factor, pretrained)
            aux_channel = 48  # 96
            out_channel = 160  # 320
        else:
